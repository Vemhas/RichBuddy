      ...
      <div>
        ...
        </button>
        {
          companies.map(d =>{
            return(
                <div>
                  <p>Ticker: {d.ticker} : Shares: {d.shares}</p>
                </div>
            )
          } )
        }
        <hr></hr>
        {
          cryptos.map(d =>{
            return(
                <div>
                  <p>Name: {d.name} : Amount: {d.amount} : PriceUSD: {d.priceUsd}</p>
                </div>
            )
          } )
        }
        <hr></hr>
        {
          realestate.map(d =>{
            return(
                <div>
                  <p>Name: {d.name} : Revenue: {d.revenue} : Verdi: {d.value}</p>
                </div>
            )
          } )
        }
        <hr></hr>
        {
          shares.map(d =>{
            return(
                <div>
                  <p>Name: {d.name} : Eierandel %: {d.ownershipPercentage} : Verdi: {d.value}</p>
                </div>
            )
          } )
        }
